...
Previously, I worked on rod insertion, soft-body projective dynamics, cutting simulation, and VBD-based optimization methods. I am currently a research assistant at [UCLA](https://www.ucla.edu/), advised by Dr. [Chenfanfu Jiang](https://www.math.ucla.edu/~cffjiang/index.html). <span style="color: #8B5A2B;">My current work focuses on robotics and simulation.</span>
...
- Working on a simulation and robotics project.
</div>
...
- **Manuscript in preparation**: Yukun Zhou and other authors. About Rod Insertion. Manuscript in preparation, 2026.
- Completed the main experiments and produced a paper draft on accurate rod-insertion simulation algorithms based on Projective Dynamics and Cosserat rods using Lagrangian constraint-based methods, with contact and friction.
- Contributed to performance improvements for the Vertex Block Descent project and paper.
- Developed and reproduced simulation systems including SDF soft-body contact, DiSect differentiable cutting, FEM, Projective Dynamics cutting with low-rank update methods, and lung puncturing simulation with Warp.
...
<p><small><em>VBD images are not uploaded because the manuscript is currently under review.</em></small></p>
